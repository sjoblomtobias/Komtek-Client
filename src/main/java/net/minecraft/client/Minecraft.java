...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void displayGuiScreen(Screen screenIn)
    {
        ...
        if (screenIn == null && this.theWorld == null)
        {
            screenIn = new GuiMainMenu();
        }
        else if (screenIn == null && this.thePlayer.getHealth() <= 0.0F)
        {
            screenIn = new GuiGameOver();
        }

        if (screenIn instanceof GuiMainMenu)
        {
            this.gameSettings.showDebugInfo = false;
            this.ingameGUI.getChatGUI().clearChatMessages();
        }

        this.currentScreen = (Screen) screenIn;
        ...
        if (screenIn != null)
        {
            ...
            ((Screen) screenIn).setWorldAndResolution(this, i, j);
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (k == 61)
                        {
                            ...
                            this.gameSettings.showLagometer = Screen.isAltKeyDown();
                        }
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        networkmanager.setNetHandler(new NetHandlerLoginClient(networkmanager, this, (Screen)null));
