...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public NetHandlerLoginClient(NetworkManager networkManagerIn, Minecraft mcIn, Screen p_i45059_3_)
    {
        this.networkManager = networkManagerIn;
        this.mc = mcIn;
        this.previousScreen = p_i45059_3_;
    }
    ...
    {
        this.mc.displayGuiScreen(new GuiDisconnected(this.previousScreen, "connect.failed", reason));
    }
