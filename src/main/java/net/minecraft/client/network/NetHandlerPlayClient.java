...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public NetHandlerPlayClient(Minecraft mcIn, Screen p_i46300_2_, NetworkManager p_i46300_3_, GameProfile p_i46300_4_)
    {
        this.gameController = mcIn;
        this.screenServer = p_i46300_2_;
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        if (!this.doneLoadingTerrain)
        {
            ...
            this.gameController.displayGuiScreen((Screen)null);
        }
    }
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(this.screenServer, "disconnect.lost", reason));
        }
        else
        {
                    ...
                    public void run()
                    {
                        NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                        {
                            public void confirmClicked(boolean result, int id)
                            {
                                ...
                                NetHandlerPlayClient.this.gameController.displayGuiScreen((Screen)null);
                            }
