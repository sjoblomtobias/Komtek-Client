...
public class GuiTextField extends Gui
{
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_)
    {
        ...
        else if (Screen.isKeyComboCtrlA(p_146201_2_))
        {
            this.setCursorPositionEnd();
            this.setSelectionPos(0);
            return true;
        }
        else if (Screen.isKeyComboCtrlC(p_146201_2_))
        {
            Screen.setClipboardString(this.getSelectedText());
            return true;
        }
        else if (Screen.isKeyComboCtrlV(p_146201_2_))
        {
            if (this.isEnabled)
            {
        ...
        else if (Screen.isKeyComboCtrlX(p_146201_2_))
        {
            Screen.setClipboardString(this.getSelectedText());
