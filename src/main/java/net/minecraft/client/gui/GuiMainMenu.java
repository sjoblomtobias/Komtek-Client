...
public class GuiMainMenu extends Screen implements GuiYesNoCallback {
    ...
    public GuiMainMenu() {
        ...
        try {
            ...
            bufferedreader = new BufferedReader(new InputStreamReader(Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("texts/splashes.txt")).getInputStream(), Charsets.UTF_8));
            String s;
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, j + 48, I18n.format("Klicka inte.")));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 3) {
            try {
                ...
                clazz.getMethod("browse", URI.class).invoke(object, new URI("https://www.youtube.com/watch?v=dQw4w9WgXcQ"));
